...
export interface DecompositionConfig {
  enabled: boolean; production: boolean; dataDir: string; falKey?: string; authMode: 'local-operator' | 'development'; passwordHash?: string;
...
export function readDecompositionConfig(env = process.env): DecompositionConfig {
  ...
  return { enabled, production, dataDir, falKey: env.FAL_KEY?.trim() || undefined, authMode, passwordHash, allowedOrigins: origins,
