...
it('restores saved per-candidate guidance and exposes mask identity independently of a legacy filename', () => {
  ...
  expect(html).toContain('candidate-8 (45.0% of image)');
  expect(html).toContain('candidate-007-overlay.png');
